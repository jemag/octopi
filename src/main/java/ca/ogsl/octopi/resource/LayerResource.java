...
public class LayerResource {
    ...
    @GetMapping("/layers")
    @Operation(summary = "Returns a list objects with the base type: Layer. Each layer will be a child type(such as WMSLayer or WFSLayer)")
//    @Cacheable(value = "stations", condition = "#stationCode == null")
    ...
    public Layer postCreateLayer(Layer layer)
            throws AppException {
        return this.layerService.postCreateLayer(layer);
    }
